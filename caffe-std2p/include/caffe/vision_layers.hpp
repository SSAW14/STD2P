...
template <typename Dtype>
class SDDPLayer : public Layer<Dtype> {
 public:
  explicit SDDPLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
  ...
  virtual inline const char* type() const { return "SDDP"; }
 ...
 protected:
  ...
  Blob<int> blob_segments_;
  Blob<int> blob_labels_;
  Blob<double> blob_idx_;
};

template <typename Dtype>
class TDDPLayer : public Layer<Dtype> {
 public:
  explicit TDDPLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
  ...
  virtual inline const char* type() const { return "TDDP"; }
...
template <typename Dtype>
class R2PLayer : public Layer<Dtype> {
 public:
  explicit R2PLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);

  virtual inline const char* type() const { return "R2P"; }
 ...
 */
template <typename Dtype>
class PCropLayer : public Layer<Dtype> {
 public:
  explicit PCropLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
  ...
  virtual inline const char* type() const { return "PCrop"; }
